...
const HeroSection = () => {
  ...
  const floatingIcons = [
    ...
    { Icon: Globe, position: { top: '30%', right: '10%' }, delay: 1 },
    { Icon: Github, position: { top: '70%', right: '20%' }, delay: 1.5 },
  ];
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        ...
        >
          ...
          <motion.h1
            ...
            className="text-5xl md:text-7xl font-bold portfolio-gradient-text mb-4"
          >
            Rishi Kanaujiya
          </motion.h1>
          ...
          >
            <Button
              ...
              size="lg"
              className="portfolio-gradient text-primary-foreground hover:opacity-90 transition-opacity font-semibold px-8 py-3"
            >
